    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'openclaw.howto.title': 'How It Works',
                'openclaw.howto.step1.title': 'Order & We Install',
                'openclaw.howto.step1.desc': 'DevelopED sets up the server and installs OpenClaw for you — no technical involvement required.',
                'openclaw.howto.step2.title': 'Custom Configuration',
                'openclaw.howto.step2.desc': 'We configure the AI model, Telegram bot and tailor the assistant\'s personality to your needs.',
                'openclaw.howto.step3.title': 'Add Your Skills',
                'openclaw.howto.step3.desc': 'Web search, file processing, reminders, custom integrations — skills extend what your assistant can do.',
                'openclaw.howto.step4.title': 'Your AI Assistant Is Live',
                'openclaw.howto.step4.desc': 'Chat via Telegram 24/7 from anywhere. Your assistant works even while you sleep.',
                'openclaw.faq.title': 'Frequently Asked Questions',
                'openclaw.faq.q1': 'What is an AI assistant for business?',
                'openclaw.faq.a1': 'A business AI assistant is software that automates routine tasks — answering questions, processing documents, and delivering information instantly. OpenClaw runs on your own server, so your business data never leaves the EU.',
                'openclaw.faq.q2': 'How does the OpenClaw AI assistant work?',
                'openclaw.faq.a2': 'OpenClaw runs 24/7 on your server in the EU. You communicate with it via Telegram — as simply as messaging a colleague. It uses advanced AI models (Google Gemini, Anthropic Claude) and can handle web search, file processing, reminders, and much more.',
                'openclaw.faq.q3': 'Do I need technical knowledge to use an AI assistant?',
                'openclaw.faq.a3': 'No. DevelopED handles the full installation, configuration and launch of OpenClaw. You simply message the assistant via Telegram — no technical knowledge required.',
                'openclaw.faq.q4': 'What is the difference between OpenClaw and ChatGPT?',
                'openclaw.faq.a4': 'ChatGPT is a public service where your inputs may be used for model training. OpenClaw runs on your private EU server — equally powerful AI, but your data remains exclusively yours.',
            ...
            sk: {
                ...
                'openclaw.howto.title': 'Ako to funguje?',
                'openclaw.howto.step1.title': 'Objednajte a my nainštalujeme',
                'openclaw.howto.step1.desc': 'DevelopED nasadí server a nainštaluje OpenClaw za vás — bez vašej technickej účasti.',
                'openclaw.howto.step2.title': 'Konfigurácia podľa vás',
                'openclaw.howto.step2.desc': 'Nakonfigurujeme AI model, Telegram bota a prispôsobíme osobnosť asistenta vašim potrebám.',
                'openclaw.howto.step3.title': 'Pridáme vaše skills',
                'openclaw.howto.step3.desc': 'Vyhľadávanie na webe, práca so súbormi, pripomienky, vlastné integrácie — skills rozšíria schopnosti asistenta.',
                'openclaw.howto.step4.title': 'Váš AI asistent je online',
                'openclaw.howto.step4.desc': 'Komunikujete cez Telegram 24/7 odkiaľkoľvek. Asistent pracuje za vás kým spíte.',
                'openclaw.faq.title': 'Často kladené otázky',
                'openclaw.faq.q1': 'Čo je AI asistent pre firmy?',
                'openclaw.faq.a1': 'AI asistent pre firmy je softvér, ktorý automatizuje rutinné úlohy — odpovedá na otázky, spracováva dokumenty a poskytuje informácie okamžite. OpenClaw beží na vašom vlastnom serveri, takže vaše firemné dáta nikdy neopustia EÚ.',
                'openclaw.faq.q2': 'Ako funguje OpenClaw AI asistent?',
                'openclaw.faq.a2': 'OpenClaw beží 24/7 na vašom serveri v EÚ. Komunikujete s ním cez Telegram — rovnako jednoducho ako by ste písali kolegovi. Využíva pokročilé AI modely (Google Gemini, Anthropic Claude) a zvládne vyhľadávanie, prácu so súbormi, pripomienky a oveľa viac.',
                'openclaw.faq.q3': 'Potrebujem technické znalosti na používanie AI asistenta?',
                'openclaw.faq.a3': 'Nie. DevelopED zabezpečí celú inštaláciu, konfiguráciu a spustenie OpenClaw. Vy len píšete asistentovi cez Telegram — žiadne technické znalosti nie sú potrebné.',
                'openclaw.faq.q4': 'Aký je rozdiel medzi OpenClaw a ChatGPT?',
                'openclaw.faq.a4': 'ChatGPT je verejná služba kde vaše vstupy môžu byť použité na tréning modelu. OpenClaw beží na vašom súkromnom serveri v EÚ — rovnako výkonný AI, ale vaše dáta zostávajú výhradne vaše.',
